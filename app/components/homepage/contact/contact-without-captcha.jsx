...
import { isValidEmail } from '@/utils/check-email'; // Adjust the import as needed
...
function ContactWithoutCaptcha() {
  ...
  const handleSendMail = async (e) => {
    ...
    const userID = process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY; // This is your public key

    const templateParams = {
      from_name: userInput.name,  // matches {{from_name}} in template
      to_name: 'Your Name',       // Replace with your name or use dynamic data
      message: userInput.message, // matches {{message}} in template
      reply_to: userInput.email,  // Add reply_to to include the sender's email
    };
